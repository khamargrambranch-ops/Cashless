...
const merchantName = ref('মেসার্স খামারগ্রাম স্টোর')
...
useSeoMeta({
  title: 'পূবালী ব্যাংক বাংলা কিউআর পেমেন্ট সেবা - খামারগ্রাম ও বেলকুচি',
  ogTitle: 'পূবালী ব্যাংক বাংলা কিউআর পেমেন্ট সেবা - খামারগ্রাম ও বেলকুচি',
  description: 'পূবালী ব্যাংক পিএলসি খামারগ্রাম শাখা ও বেলকুচি উপশাখার মাধ্যমে সম্পূর্ণ ফ্রিতে ০% মার্চেন্ট চার্জে (No MDR) বাংলা কিউআর (Bangla QR) পেমেন্ট গ্রহণ করুন। ট্রেড লাইসেন্স ছাড়াই মার্চেন্ট অ্যাকাউন্ট খুলুন!',
  ogDescription: 'পূবালী ব্যাংক পিএলসি খামারগ্রাম শাখা ও বেলকুচি উপশাখার মাধ্যমে সম্পূর্ণ ফ্রিতে ০% মার্চেন্ট চার্জে (No MDR) বাংলা কিউআর (Bangla QR) পেমেন্ট গ্রহণ করুন। ট্রেড লাইসেন্স ছাড়াই মার্চেন্ট অ্যাকাউন্ট খুলুন!',
  keywords: 'বাংলা কিউআর, পূবালী ব্যাংক পিএলসি, খামারগ্রাম শাখা, বেলকুচি উপশাখা, PI App, Bangla QR, Pubali Bank PLC, Merchant Account, No MDR, 0% Fee, ডিজিটাল পেমেন্ট, সিরাজগঞ্জ',
  ogType: 'website',
  ogLocale: 'bn_BD',
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center border-b border-slate-800 pb-8">
          ...
          <div class="text-center text-xs space-y-1">
            ...
            <p class="text-slate-500">খামারগ্রাম শাখা ও বেলকুচি উপশাখা, সিরাজগঞ্জ অঞ্চল।</p>
          </div>
